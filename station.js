...
(function() {
  ...
  const obj_dm_iv = {
    ...
    musicasList: [
      { name: 'FK', arquivo: 'radio_dance_mix/FK/playlist.m3u8' } // <-- Removido o 'musicas/'
    ]
  };
  ...
  const obj_dm_eflc = {
    isMixRadio: true,
    musicasList: [
      { name: 'CROOKERS_MIX', arquivo: 'radio_dance_mix/CROOKERS_MIX/playlist.m3u8' } // <-- Removido o 'musicas/'
    ]
  };
  ...
  const obj_beat_iv = {
    isMixRadio: true,
    musicasList: [
      { name: 'BEAT', arquivo: 'radio_beat_95/BEAT/playlist.m3u8' }
    ]
  };
  ...
  const obj_beat_eflc = {
    ...
    musicasList: [
      ...
      id: 'e1_beat_mix_p1', 
      name: 'E1_BEAT_MIX_P1', 
      arquivo: 'radio_beat_95/E1_BEAT_MIX_P1/playlist.m3u8',
      nextMix: 'E1_BEAT_MIX_P2' // <-- A MUDANÇA É AQUI (nextMix em vez de nextTrack)
    },
    { 
      id: 'e1_beat_mix_p2', 
      name: 'E1_BEAT_MIX_P2', 
      arquivo: 'radio_beat_95/E1_BEAT_MIX_P2/playlist.m3u8',
      linkedOnly: true 
    }
    ]
  };
  ...
  const obj_wktt_iv = {
    ...
    programasList: [
      ...
      { name: '2_FIZZ_1', arquivo: 'radio_wktt/2_FIZZ_1/playlist.m3u8' },
      { name: '3_CONSERVATIVE_1', arquivo: 'radio_wktt/3_CONSERVATIVE_1/playlist.m3u8' },
      { name: '4_UNJUST_2', arquivo: 'radio_wktt/4_UNJUST_2/playlist.m3u8' },
      { name: '5_FIZZ_2', arquivo: 'radio_wktt/5_FIZZ_2/playlist.m3u8' },
      { name: '6_CONSERVATIVE_2', arquivo: 'radio_wktt/6_CONSERVATIVE_2/playlist.m3u8' }
    ]
  };
  ...
  const obj_wktt_eflc = {
    ...
    programasList: [
      ...
      { name: '8_MONO_CONSPIRE_PART_1', arquivo: 'radio_wktt/8_MONO_CONSPIRE_PART_1/playlist.m3u8' },
      { name: '9_MONO_CONSPIRE_PART_2', arquivo: 'radio_wktt/9_MONO_CONSPIRE_PART_2/playlist.m3u8' }
    ]
  };
  ...
  const obj_lchc_eflc = {
    ...
    grupoAdv: G.adv.eflc,
    musicasList: [
      { id: 'lchc_mix', name: 'LCHC_MIX', arquivo: 'radio_hardcore/musicas/LCHC_32K_PH/playlist.m3u8' }
    ]
  };
  ...
  const obj_lchc_complete = {
    ...
    mixData: { id: 'lchc_mix', name: 'LCHC_MIX', arquivo: 'radio_hardcore/musicas/LCHC_32K_PH/playlist.m3u8' } 
  };
  ...
  const obj_vlad_eflc = {
    ...
    grupoAdv: G.adv.eflc,
    musicasList: [
      { id: 'vlad_mix', name: 'EUROBEAT_MIX', arquivo: 'radio_vladivostok/musicas/EUROBEAT_MIX/playlist.m3u8' }
    ]
  };
  ...
  const obj_vlad_complete = {
    ...
    mixData: { id: 'vlad_mix', name: 'EUROBEAT_MIX', arquivo: 'radio_vladivostok/musicas/EUROBEAT_MIX/playlist.m3u8' }
  };
  ...
  const obj_sjs_eflc = {
    ...
    musicasList: [
      { id: 'sjs_mix', name: 'SANTIAGO_SOUNDS', arquivo: 'radio_san_juan_sounds/musicas/SANTIAGO_SOUNDS/playlist.m3u8' }
    ]
  };
  ...
  const obj_sjs_complete = {
    ...
    mixData: { id: 'sjs_mix', name: 'SANTIAGO_SOUNDS', arquivo: 'radio_san_juan_sounds/musicas/SANTIAGO_SOUNDS/playlist.m3u8' }
  };
  ...
  const obj_massiveb_iv = {
    ...
    musicasList: [
      { id: 'massiveb_mix', name: 'MASSIVEB_MIX', arquivo: 'radio_bobby_konders/MASSIVEB_MIX/playlist.m3u8' }
    ]
  };
  ...
  const lazlow_prog_iv = [
    { name: 'INTEGRITY_01', arquivo: 'radio_lazlow/INTEGRITY_01/playlist.m3u8' },
    { name: 'INTEGRITY_02', arquivo: 'radio_lazlow/INTEGRITY_02/playlist.m3u8' },
    { name: 'INTEGRITY_03', arquivo: 'radio_lazlow/INTEGRITY_03/playlist.m3u8' },
    { name: 'INTEGRITY_04', arquivo: 'radio_lazlow/INTEGRITY_04/playlist.m3u8' }
  ];

  const lazlow_prog_eflc = [
    { name: 'INTEGRITY_MONO_5', arquivo: 'radio_lazlow/INTEGRITY_MONO_5/playlist.m3u8' },
    { name: 'INTEGRITY_MONO_6', arquivo: 'radio_lazlow/INTEGRITY_MONO_6/playlist.m3u8' },
    { name: 'INTEGRITY_MONO_7', arquivo: 'radio_lazlow/INTEGRITY_MONO_7/playlist.m3u8' },
    { name: 'INTEGRITY_MONO_8', arquivo: 'radio_lazlow/INTEGRITY_MONO_8/playlist.m3u8' }
  ];
  ...
  const obj_ny_classics_iv = {
    ...
    musicasList: [
      { id: 'classics_mix', name: 'CLASSICS_MIX', arquivo: 'radio_ny_classics/CLASSICS_MIX/playlist.m3u8' }
    ]
  };
  ...
  const obj_plr_iv = {
    ...
    programasList: [
      ...
      { name: 'THE_SEANCE', arquivo: 'radio_plr/THE_SEANCE/playlist.m3u8' }
    ]
  };
  ...
  const obj_ramjam_eflc = {
    ...
    musicasList: [
      { id: 'ramjam_mix', name: 'RAMJAM_MIX', arquivo: 'radio_ramjamfm/RAMJAM_MIX/playlist.m3u8' }
    ]
  };
